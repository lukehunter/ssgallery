...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" href="%SSG_HOME_URL%data/photoswipe.css">
	    <script src="%SSG_HOME_URL%data/js/photoswipe.min.js"></script>
	    <script src="%SSG_HOME_URL%data/js/photoswipe-ui-default.min.js"></script>
